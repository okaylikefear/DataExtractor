...
[[<sbees:misc:17>, <forestrytechnology:material>, <sbees:misc:17>],
 [<senergetics:chip:1>, <Forestry:factory:2>, <senergetics:chip:1>],
 [<senergetics:plate-compressed:10>, <forestrytechnology:material>, <senergetics:plate-compressed:10>]]);

# --- SQUEEZER
recipes.addShaped(<forestrytechnology:blockAdvancedMachine:1>,
[[<sbees:misc:16>, <forestrytechnology:material>, <sbees:misc:17>],
 [<senergetics:chip:1>, <Forestry:factory:5>, <senergetics:chip:1>],
 [<senergetics:plate-compressed:10>, <forestrytechnology:material>, <senergetics:plate-compressed:10>]]);

# --- FERMENTER
recipes.addShaped(<forestrytechnology:blockAdvancedMachine:2>,
[[<sbees:misc:16>, <forestrytechnology:material>, <sbees:misc:16>],
 [<senergetics:chip:1>, <Forestry:factory:3>, <senergetics:chip:1>],
 [<senergetics:plate-compressed:10>, <forestrytechnology:material>, <senergetics:plate-compressed:10>]]);

# --- CARPENTER
recipes.addShaped(<forestrytechnology:blockAdvancedMachine:3>,
[[<sbees:misc:16>, <forestrytechnology:material>, <sbees:misc:17>],
 [<senergetics:chip:1>, <Forestry:factory:1>, <senergetics:chip:1>],
 [<senergetics:plate-compressed:10>, <forestrytechnology:material>, <senergetics:plate-compressed:10>]]);

# --- DISTILLER
recipes.addShaped(<forestrytechnology:blockAdvancedMachine:4>,
[[<sbees:misc:17>, <forestrytechnology:material>, <sbees:misc:17>],
 [<senergetics:chip:1>, <Forestry:factory:6>, <senergetics:chip:1>],
 [<senergetics:plate-compressed:10>, <forestrytechnology:material>, <senergetics:plate-compressed:10>]]);
